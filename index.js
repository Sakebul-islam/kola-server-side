...
// DB URI
const uri = `mongodb+srv://${process.env.USER_DB}:${process.env.USER_KEY_DB}@cluster0.ltwp59m.mongodb.net/cleanCoDB?retryWrites=true&w=majority`;
...
app.get('/', async (req, res) => {
  res.send('Kola Food Sharing server is running : 🆗');
});
